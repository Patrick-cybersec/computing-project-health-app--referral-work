...
public class RecordingCyclingClimbingRunningActivity extends AppCompatActivity implements SensorEventListener {
    ...
    private String mapExerciseToActivityType(String exercise) {
        // Map exercise to ActivityType based on spinner selection
        switch (exercise.toLowerCase()) {
            ...
            case "climbing":
                return "Climbing";
            default:
                return "Cycling"; // Default to Cycling for "Select exercise" or unknown
        }
    }

    private void submitRecord() {
        String time = timerText.getText().toString();
        String exercise = activitySpinner.getSelectedItem().toString();
        ...
        if (exercise == null || exercise.isEmpty() || exercise.equals("Select exercise")) {
        ...
        try {
            ...
            Log.d("RecordingCyclingClimbingRunning", "Payload: " + requestBody.toString());
                ...
                public void onResponse(Call call, Response response) throws IOException {
                    ...
                    if (response.isSuccessful()) {
                        runOnUiThread(() -> {
                            ...
                            Intent intent = new Intent(RecordingCyclingClimbingRunningActivity.this, Dashboard.class);
                            startActivity(intent);
                            finish();
                        });
                    } else {
                        Log.e("RecordingCyclingClimbingRunning", "Failed to save record: HTTP " + response.code() + ", Body: " + errorBody);
                        runOnUiThread(() -> Toast.makeText(RecordingCyclingClimbingRunningActivity.this,
