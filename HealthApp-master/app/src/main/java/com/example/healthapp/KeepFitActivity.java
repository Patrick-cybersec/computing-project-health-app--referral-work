...
public class KeepFitActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        backButton.setOnClickListener(v -> {
            Intent intent = new Intent(KeepFitActivity.this, PredefinedProgrammeActivity.class);
            startActivity(intent);
        });

        Button startButton = findViewById(R.id.startButton);
        startButton.setOnClickListener(v -> {
            Intent intent = new Intent(KeepFitActivity.this, RecordingKeepFitActivity.class);
            startActivity(intent);
        });

        Button videoButton = findViewById(R.id.videoButton);
        videoButton.setOnClickListener(v -> {
            String youtubeUrl = "https://www.youtube.com/watch?v=8wPjxtfix7Q";
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (itemId == R.id.action_music) {
            ...
            Intent intent = new Intent(KeepFitActivity.this, Login.class);
            startActivity(intent);
            finish();
            return true;
